...
export interface ApiPayementPayement extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    reservation: Schema.Attribute.Relation<
      ...
      'api::reservation.reservation'
    >;
    status_of_payement: Schema.Attribute.Enumeration<['waiting', 'payed']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProviderAccountProviderAccount
  extends Struct.CollectionTypeSchema {
  collectionName: 'provider_accounts';
  info: {
    displayName: 'provider_account';
    pluralName: 'provider-accounts';
    singularName: 'provider-account';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiReservationReservation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    debut_date: Schema.Attribute.DateTime;
    ...
    > &
      Schema.Attribute.Private;
    payement: Schema.Attribute.Relation<'oneToOne', 'api::payement.payement'>;
    percentage_amount: Schema.Attribute.Decimal;
    percentage_payed: Schema.Attribute.Boolean;
    publishedAt: Schema.Attribute.DateTime;
    status_of_reservstion: Schema.Attribute.Enumeration<
      ['waiting', 'validated', 'canceled ']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiUserInAppUserInApp extends Struct.CollectionTypeSchema {
  collectionName: 'user_in_apps';
  info: {
    description: '';
    displayName: 'User_in_app';
    pluralName: 'user-in-apps';
    singularName: 'user-in-app';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    Type_of_user: Schema.Attribute.Enumeration<
      ['client', 'provider', 'admin_client', 'admin_provider', 'super_admin']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::provider-account.provider-account': ApiProviderAccountProviderAccount;
      'api::provider.provider': ApiProviderProvider;
      'api::reservation.reservation': ApiReservationReservation;
      'api::service.service': ApiServiceService;
      'api::user-in-app.user-in-app': ApiUserInAppUserInApp;
